...
------------------------------------------------------------------------------ */
  ...
  const enableIdentityInference =
    params.enableWebRequestIdentityInference === true;
...
------------------------------------------------------------------------------ */
  ...
  const sessionInputEventsName = enableIdentityInference
    ? identityEventsName
    : rawEventsName;
...
------------------------------------------------------------------------------ */
  ...
  return publish(finalName, {
    ...
    tags,
     description: enableIdentityInference
