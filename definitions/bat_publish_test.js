/* For use by dfe-analytics-dataform developers working with Publish test data only - for example code to use in your project, see definitions/example.js
   ...
   This is the standard dfe-analytics (event-sourced) pipeline. The Airbyte dual-run
   definitions live in a separate file and generate _airbyte-suffixed models alongside these.
*/
